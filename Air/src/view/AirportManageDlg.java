...
public class AirportManageDlg extends JDialog {
	...
	private static AirportManageDlg inst;
	 ...
	 * @param args
	 */
	public static AirportManageDlg getInstance() {
		if (inst == null)
			inst = new AirportManageDlg();
		return inst;
	}
	...
	public static void main(String args[]) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AirportManageDlg dialog = new AirportManageDlg();
	...
	public AirportManageDlg() {
		...
		addAManageButton.addActionListener(new ActionListener() {
			public void actionPerformed(final ActionEvent e) {
				...
				if(airPortDAO.isExistAirport(user)){
					addminfo.setText("Airport already exists!");
					return;
				}
				if(1==airPortDAO.addAirport(user))
		...
		addAManageButton.setText("Add a Airport");
